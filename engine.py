...
#SILENCING ANNOUNCEMENT TEST <- COMMENT until          logger.error(f"Failed to send final summary to parent: {e}") to silence again
...
# SILENCING ANNOUNCEMENT TEST <-comment the "try" below to silence again
